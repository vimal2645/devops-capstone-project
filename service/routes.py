...
def get_account(account_id):
    ...
    """
    app.logger.info("Request to read Account with id: %d", account_id)
...
def update_account(account_id):
    ...
    """
    app.logger.info("Request to update Account with id: %d", account_id)
    account = Account.find(account_id)
    if not account:
        abort(status.HTTP_404_NOT_FOUND, f"Account with id [{account_id}] not found.")
    check_content_type("application/json")
...
def delete_account(account_id):
    ...
    """
    app.logger.info("Request to delete Account with id: %d", account_id)
    account = Account.find(account_id)
    if not account:
        abort(status.HTTP_404_NOT_FOUND, f"Account with id [{account_id}] not found.")
    account.delete()
